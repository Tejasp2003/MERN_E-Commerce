...
const generateToken = (res, userId) => {
  ...
  res.cookie("jwt", token, {
    ...
    sameSite: "none" // this is to ensure that the cookie is sent only in a first party context and not in a third party context i.e it is not sent to another website when the user clicks on a link in the website that contains the cookie
  })
